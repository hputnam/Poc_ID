...
NS1 <- st_read("data/Moorea_polygons/NS1_boundary.shp")
NS2 <- st_read("data/Moorea_polygons/NS2_boundary.shp")
NS3 <- st_read("data/Moorea_polygons/NS3_boundary.shp")
NS4 <- st_read("data/Moorea_polygons/NS4_boundary.shp")
NS5 <- st_read("data/Moorea_polygons/NS5_boundary.shp")
...
st_write(NS2.samples, layer_options = "GEOMETRY=AS_XY", "transect.site.coords2.csv")
st_write(NS3.samples, layer_options = "GEOMETRY=AS_XY", "transect.site.coords3.csv")
st_write(NS4.samples, layer_options = "GEOMETRY=AS_XY", "transect.site.coords4.csv")
st_write(NS5.samples, layer_options = "GEOMETRY=AS_XY", "transect.site.coords5.csv")

sites <- list.files(path=".", full.names = FALSE) %>%
  str_subset("\\.csv$")  %>%
  lapply(read_csv) %>% 
  bind_rows
