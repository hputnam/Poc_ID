...
#load wax data
wax.data <- read.csv("baseline_TPC_physio/data/TPC_surface_area/TPC_surface_area_data.csv", header=TRUE)
...
smpls%>%
  select(fragment_ID, surface.area.cm2)%>%
    write_csv("baseline_TPC_physio/output/surface.area.calc.csv")
```
