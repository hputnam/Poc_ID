...
## Import data
```{r, warning = FALSE}
Photodata <- read.csv("data/May_Photo_extracted_rates.csv")
```
...
ggsave("output/May_TPC_estimates_SharpSchool_Photosynthesis.pdf", estimate.plots, dpi=300, w=6, h=2, units="in")
``` 
...
ggsave("output/May_Photosynthesis_TPC_and_estimates.pdf", figure, dpi=300, w=6, h=8, units="in")
