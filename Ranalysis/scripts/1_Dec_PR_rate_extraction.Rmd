...
sa <- read_csv(file = "data/Dec_surface.area.calc.csv")
...
write.csv(Photodata, file="data/Dec_Photo_extracted_rates.csv")
...
write.csv(Respdata, file="data/Dec_Resp_extracted_rates.csv")
