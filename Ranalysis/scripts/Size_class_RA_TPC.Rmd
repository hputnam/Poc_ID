...
ggplot(relative_abundance.manava, aes(x = Transect, y = Relative_Abundance, fill = Species.ID)) +
...
fig1 <- ggplot(relative_abundance.manava, aes(x = Site.x, y = Relative_Abundance, fill = Species.ID)) +
  geom_bar(stat = "identity", position = "fill") +
