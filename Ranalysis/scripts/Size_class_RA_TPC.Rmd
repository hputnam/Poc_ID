...
cols.species <- data(Species = factor(c("P. tuahiniensis",
...
RA.manava.plot_species <- ggplot(sample_sizes_manava, aes(x = Transect, y = relative_abundance.manava, fill = Species.ID)) +
  ...
  geom_text(data = sample_sizes_manava, aes(x = Site, y = 1.1, label = Sample_Size),inherit.aes = FALSE, size = 2, vjust = 0, color = "black")
